...
def add_cafe():
    ...
    if request.method == 'POST':
        ...
        final_id = []
        id = 1
        data = pd.read_csv("My book\cafe-data.csv", header=None, index_col = False).to_dict()
        ...
        name = f"My book//static//user{id}.PNG"
        profile.save((name))
        ...
        df.to_csv('My book\cafe-data.csv', mode='a', index=False, header=False)
